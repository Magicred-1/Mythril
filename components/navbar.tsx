...
const Navbar = () => {
  ...
  return (
    <div className={` ${lexend.className} h-auto flex flex-col sm:flex-row justify-between items-center p-4 sm:p-9`}>
      ...
      <div className="flex items-center mt-4 sm:mt-0 relative sm:hidden">
        <button
          onClick={toggleMenu}
      ...
      <div className={`sm:flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 mt-4 sm:mt-0 ${isMenuOpen ? 'flex' : 'hidden'}`}>
